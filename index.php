					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
							<li><a class="menu active" href="view_dept.php"> Departments</a></li>
							<li><a class="menu" href="view_doctor.php">Doctors </a></li>
					        <li><a class="menu" href="insert_main.php">Records</a></li>
					        <li><a class="menu" href="insert_trans.php">Transactions</a></li>
					        <li><a class="menu" href="nurhomereport.php">departmental report</a></li>
				...
				<div class="contact-caption clearfix">
					...
					<div class="col-md-5 contact-info text-left">
						...
						<div class="info-detail">
							<ul><li><i class="fa fa-calendar"></i><span>24 X 7 Hours:</span> Service Provider</li></ul>
							<ul><li><i class="fa fa-map-marker"></i><span>Address:</span> 123 Park Street , Kolkata-700058</li></ul>
							<ul><li><i class="fa fa-phone"></i><span>Phone:</span> (033) 24651578</li></ul>
							<ul><li><i class="fa fa-fax"></i><span>Fax:</span> (+91) 9863251478</li></ul>
							<ul><li><i class="fa fa-envelope"></i><span>Email:</span> sshospital@gmail.com</li></ul>
						</div>
					</div>
